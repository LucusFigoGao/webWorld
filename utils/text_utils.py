...
def clean_action(pred):
    if "Let's think step-by-step. " in pred:
        pred.replace("Let's think step-by-step. ", "Let\'s think step-by-step. ")
    if "Let\'s think step-by-step. " not in pred:
        pred = "Let\'s think step-by-step. " + pred
    return pred
